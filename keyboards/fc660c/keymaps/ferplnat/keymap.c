...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
        QK_BOOT,_______,_______,_______,_______,_______,_______,_______,_______,    _______,     _______,_______,_______,_______,     LSG(KC_S),
        ...
        _______,_______,_______,_______,_______,_______,_______,_______,RCS(KC_TAB),RCTL(KC_TAB),_______,_______,     _______,
