...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_default(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______,     _______, _______, _______, _______, LSG(KC_S),
        _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______,     _______, _______, _______, _______, BS_TOGG,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______,     _______, _______,          _______, _______,
        _______,          _______, _______, _______, _______, _______, KC_APP,  RCS(KC_TAB),RCTL(KC_TAB),_______, _______, _______, _______, QK_BOOT,
